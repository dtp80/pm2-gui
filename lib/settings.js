...
function updateSettings (patch) {
  ...
  Object.keys(patch).forEach(function (key) {
    if (Object.prototype.hasOwnProperty.call(db.DEFAULT_SETTINGS, key) || key.indexOf('log_') === 0 || key.indexOf('public_') === 0 || key === 'readonly' || key === 'refresh' || key === 'process_refresh' || key === 'origins') {
